...
- Best walk-forward ablation by 1c slippage PnL: `market_momentum_logistic` (+0.6900 / +0.4500 after 1c/2c)
- Best lockbox ablation by 1c slippage PnL: `market_momentum_logistic` (+2.4200 / +2.3400 after 1c/2c)
...
| 80_100 | side_score_bucket | score_2_6 | 501 | 67 | 0.889 | 95.8% | 6.9% | +0.0693 | True | pass |
| 20_35 | game_time_bucket | 0000_0600 | 3 | 2 | 0.270 | 33.3% | 6.3% | +0.0633 | False | too_few_rows |
| 50_65 | side_score_bucket | score_2_6 | 218 | 41 | 0.593 | 65.6% | 6.3% | +0.0629 | True | pass |
| 20_35 | side_score_bucket | score_2_6 | 118 | 22 | 0.277 | 33.9% | 6.2% | +0.0615 | True | pass |
| 00_20 | structure_score_bucket | struct_ge_2 | 204 | 16 | 0.129 | 18.1% | 5.3% | +0.0527 | True | pass |
| 50_65 | structure_score_bucket | struct_1_2 | 53 | 17 | 0.593 | 64.2% | 4.9% | +0.0489 | True | pass |
| 65_80 | side_nw_bucket | nw_ge_8k | 260 | 35 | 0.748 | 79.2% | 4.5% | +0.0446 | True | pass |
| 80_100 | game_time_bucket | 0900_1200 | 374 | 48 | 0.881 | 92.2% | 4.1% | +0.0414 | True | pass |
| 35_50 | side_mom_100_bucket | mom_1k_5k | 286 | 45 | 0.437 | 47.6% | 3.9% | +0.0388 | True | pass |
| 65_80 | game_time_bucket | 0600_0900 | 252 | 44 | 0.730 | 76.6% | 3.6% | +0.0360 | True | pass |
| 65_80 | game_time_bucket | 0900_1200 | 307 | 51 | 0.738 | 77.2% | 3.4% | +0.0343 | True | pass |
| 65_80 | side_score_bucket | score_ge_6 | 274 | 36 | 0.742 | 77.0% | 2.8% | +0.0284 | True | pass |
| 35_50 | game_time_bucket | 0600_0900 | 352 | 45 | 0.437 | 46.3% | 2.6% | +0.0262 | True | pass |
| 80_100 | side_nw_bucket | nw_ge_8k | 1091 | 70 | 0.899 | 92.4% | 2.5% | +0.0251 | True | pass |
| 65_80 | structure_score_bucket | struct_1_2 | 124 | 25 | 0.741 | 76.6% | 2.5% | +0.0249 | True | pass |
...
| 50_65 | side_mom_100_bucket | mom_ge_5k | 44 | 14 | 0.592 | 61.4% | 2.2% | +0.0216 |
| 35_50 | side_nw_bucket | nw_-3k_3k | 784 | 54 | 0.437 | 45.5% | 1.8% | +0.0179 |
| 80_100 | game_time_bucket | 0600_0900 | 278 | 37 | 0.887 | 90.3% | 1.6% | +0.0157 |
| 65_80 | side_mom_100_bucket | mom_-1k_1k | 615 | 70 | 0.734 | 74.8% | 1.4% | +0.0144 |
| 65_80 | side_mom_100_bucket | mom_1k_5k | 512 | 68 | 0.738 | 75.2% | 1.4% | +0.0137 |
| 80_100 | side_mom_100_bucket | mom_-1k_1k | 693 | 70 | 0.883 | 89.5% | 1.2% | +0.0118 |
| 35_50 | side_score_bucket | score_-2_2 | 616 | 58 | 0.438 | 44.8% | 1.0% | +0.0098 |
| 50_65 | structure_score_bucket | struct_lt_-2 | 194 | 28 | 0.584 | 59.3% | 0.9% | +0.0090 |
| 80_100 | structure_score_bucket | struct_ge_2 | 531 | 53 | 0.896 | 90.4% | 0.8% | +0.0084 |
| 80_100 | side_mom_100_bucket | mom_ge_5k | 188 | 37 | 0.899 | 90.4% | 0.6% | +0.0057 |
| 20_35 | side_score_bucket | score_-2_2 | 633 | 75 | 0.280 | 28.3% | 0.3% | +0.0027 |
| 80_100 | side_score_bucket | score_-2_2 | 701 | 77 | 0.885 | 88.7% | 0.3% | +0.0026 |
...
| walk_forward | market_gettoplive_logistic | 8835490699 | 1 | 1 | 0.0% | -0.6800 | -0.6900 | -0.7000 |
| walk_forward | market_gettoplive_logistic | 8836220468 | 1 | 1 | 0.0% | -0.6600 | -0.6700 | -0.6800 |
| walk_forward | market_gettoplive_logistic | 8834932746 | 1 | 1 | 100.0% | +0.5600 | +0.5500 | +0.5400 |
| walk_forward | market_gettoplive_logistic | 8834230023 | 2 | 2 | 100.0% | +0.5400 | +0.5200 | +0.5000 |
| walk_forward | market_gettoplive_logistic | 8835373075 | 1 | 1 | 0.0% | -0.4700 | -0.4800 | -0.4900 |
| walk_forward | market_gettoplive_logistic | 8835609186 | 1 | 1 | 0.0% | -0.4600 | -0.4700 | -0.4800 |
| walk_forward | market_gettoplive_logistic | 8836485118 | 1 | 1 | 100.0% | +0.4700 | +0.4600 | +0.4500 |
| walk_forward | market_gettoplive_logistic | 8836292316 | 1 | 1 | 100.0% | +0.4100 | +0.4000 | +0.3900 |
| walk_forward | market_gettoplive_logistic | 8836692392 | 1 | 1 | 100.0% | +0.3500 | +0.3400 | +0.3300 |
| walk_forward | market_gettoplive_logistic | 8835703860 | 1 | 1 | 100.0% | +0.3300 | +0.3200 | +0.3100 |
| walk_forward | market_gettoplive_logistic | 8835818773 | 1 | 1 | 100.0% | +0.2400 | +0.2300 | +0.2200 |
| walk_forward | market_gettoplive_logistic | 8833592202 | 1 | 1 | 0.0% | -0.1100 | -0.1200 | -0.1300 |
| walk_forward | market_momentum_logistic | 8835490699 | 1 | 1 | 100.0% | +0.9400 | +0.9300 | +0.9200 |
| walk_forward | market_momentum_logistic | 8835703860 | 1 | 1 | 100.0% | +0.7700 | +0.7600 | +0.7500 |
| walk_forward | market_momentum_logistic | 8834932746 | 1 | 1 | 0.0% | -0.7000 | -0.7100 | -0.7200 |
| walk_forward | market_momentum_logistic | 8835818773 | 1 | 1 | 0.0% | -0.6300 | -0.6400 | -0.6500 |
| walk_forward | market_momentum_logistic | 8835609186 | 1 | 1 | 100.0% | +0.6100 | +0.6000 | +0.5900 |
| walk_forward | market_momentum_logistic | 8834230023 | 2 | 2 | 100.0% | +0.5400 | +0.5200 | +0.5000 |
| walk_forward | market_momentum_logistic | 8836624153 | 1 | 1 | 100.0% | +0.5100 | +0.5000 | +0.4900 |
| walk_forward | market_momentum_logistic | 8836485118 | 1 | 1 | 0.0% | -0.4800 | -0.4900 | -0.5000 |
| walk_forward | market_momentum_logistic | 8836442480 | 1 | 1 | 100.0% | +0.4600 | +0.4500 | +0.4400 |
| walk_forward | market_momentum_logistic | 8836583316 | 1 | 1 | 0.0% | -0.4300 | -0.4400 | -0.4500 |
| walk_forward | market_momentum_logistic | 8836220468 | 1 | 1 | 0.0% | -0.4200 | -0.4300 | -0.4400 |
| walk_forward | market_momentum_logistic | 8836292316 | 1 | 1 | 100.0% | +0.3500 | +0.3400 | +0.3300 |
| walk_forward | market_momentum_logistic | 8836485094 | 1 | 1 | 0.0% | -0.2700 | -0.2800 | -0.2900 |
| walk_forward | market_momentum_logistic | 8836692392 | 2 | 2 | 50.0% | -0.2600 | -0.2800 | -0.3000 |
| walk_forward | market_momentum_logistic | 8836358188 | 1 | 1 | 100.0% | +0.2200 | +0.2100 | +0.2000 |
| walk_forward | market_momentum_logistic | 8835728100 | 1 | 1 | 100.0% | +0.1900 | +0.1800 | +0.1700 |
| walk_forward | market_momentum_logistic | 8833570075 | 1 | 1 | 0.0% | -0.1600 | -0.1700 | -0.1800 |
| walk_forward | market_momentum_logistic | 8835428935 | 1 | 1 | 0.0% | -0.1600 | -0.1700 | -0.1800 |
| walk_forward | market_momentum_logistic | 8833592202 | 1 | 1 | 0.0% | -0.1100 | -0.1200 | -0.1300 |
| walk_forward | market_momentum_logistic | 8835373075 | 1 | 1 | 0.0% | -0.1000 | -0.1100 | -0.1200 |
| walk_forward | market_momentum_logistic | 8836445371 | 1 | 1 | 100.0% | +0.1100 | +0.1000 | +0.0900 |
| walk_forward | market_momentum_logistic | 8834244800 | 1 | 1 | 0.0% | -0.0500 | -0.0600 | -0.0700 |
| walk_forward | market_nw_logistic | 8834932746 | 1 | 1 | 100.0% | +0.7600 | +0.7500 | +0.7400 |
| walk_forward | market_nw_logistic | 8835490699 | 1 | 1 | 0.0% | -0.6800 | -0.6900 | -0.7000 |
| walk_forward | market_nw_logistic | 8836220468 | 1 | 1 | 0.0% | -0.6600 | -0.6700 | -0.6800 |
| walk_forward | market_nw_logistic | 8835703860 | 1 | 1 | 100.0% | +0.6500 | +0.6400 | +0.6300 |
| walk_forward | market_nw_logistic | 8834230023 | 2 | 2 | 100.0% | +0.6500 | +0.6300 | +0.6100 |
| walk_forward | market_nw_logistic | 8836583316 | 1 | 1 | 0.0% | -0.5900 | -0.6000 | -0.6100 |
| walk_forward | market_nw_logistic | 8836692392 | 2 | 2 | 100.0% | +0.5300 | +0.5100 | +0.4900 |
| walk_forward | market_nw_logistic | 8836485118 | 1 | 1 | 0.0% | -0.4800 | -0.4900 | -0.5000 |
| walk_forward | market_nw_logistic | 8835609186 | 1 | 1 | 0.0% | -0.4600 | -0.4700 | -0.4800 |
| walk_forward | market_nw_logistic | 8836442480 | 1 | 1 | 100.0% | +0.4600 | +0.4500 | +0.4400 |
| walk_forward | market_nw_logistic | 8836624153 | 1 | 1 | 100.0% | +0.4500 | +0.4400 | +0.4300 |
| walk_forward | market_nw_logistic | 8831927547 | 1 | 1 | 0.0% | -0.4000 | -0.4100 | -0.4200 |
...
| walk_forward | 1 | market_only_logistic | 0.050 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_only_logistic | 0.080 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_only_logistic | 0.100 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_only_logistic | 0.120 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_only_logistic | 0.150 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_only_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_score_logistic | 0.020 | 4 | -0.4100 | -0.4500 | -0.4900 |
| walk_forward | 1 | market_score_logistic | 0.050 | 1 | +0.6600 | +0.6500 | +0.6400 |
| walk_forward | 1 | market_score_logistic | 0.080 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_score_logistic | 0.100 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_score_logistic | 0.120 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_score_logistic | 0.150 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_score_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 1 | market_structure_logistic | 0.020 | 3 | -0.7000 | -0.7300 | -0.7600 |
| walk_forward | 1 | market_structure_logistic | 0.050 | 3 | -0.7500 | -0.7800 | -0.8100 |
| walk_forward | 1 | market_structure_logistic | 0.080 | 2 | -0.6700 | -0.6900 | -0.7100 |
| walk_forward | 1 | market_structure_logistic | 0.100 | 2 | -0.6500 | -0.6700 | -0.6900 |
| walk_forward | 1 | market_structure_logistic | 0.120 | 2 | -0.6100 | -0.6300 | -0.6500 |
| walk_forward | 1 | market_structure_logistic | 0.150 | 2 | -0.6100 | -0.6300 | -0.6500 |
| walk_forward | 1 | market_structure_logistic | 0.200 | 1 | -0.7300 | -0.7400 | -0.7500 |
| walk_forward | 2 | market_gettoplive_logistic | 0.020 | 7 | -0.6600 | -0.7300 | -0.8000 |
| walk_forward | 2 | market_gettoplive_logistic | 0.050 | 3 | +0.1400 | +0.1100 | +0.0800 |
| walk_forward | 2 | market_gettoplive_logistic | 0.080 | 1 | +0.5700 | +0.5600 | +0.5500 |
| walk_forward | 2 | market_gettoplive_logistic | 0.100 | 1 | +0.6000 | +0.5900 | +0.5800 |
| walk_forward | 2 | market_gettoplive_logistic | 0.120 | 1 | +0.6000 | +0.5900 | +0.5800 |
| walk_forward | 2 | market_gettoplive_logistic | 0.150 | 1 | +0.5800 | +0.5700 | +0.5600 |
| walk_forward | 2 | market_gettoplive_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_momentum_logistic | 0.020 | 7 | -0.1600 | -0.2300 | -0.3000 |
| walk_forward | 2 | market_momentum_logistic | 0.050 | 2 | +0.0200 | +0.0000 | -0.0200 |
| walk_forward | 2 | market_momentum_logistic | 0.080 | 1 | -0.4000 | -0.4100 | -0.4200 |
| walk_forward | 2 | market_momentum_logistic | 0.100 | 1 | -0.4000 | -0.4100 | -0.4200 |
| walk_forward | 2 | market_momentum_logistic | 0.120 | 1 | +0.5700 | +0.5600 | +0.5500 |
| walk_forward | 2 | market_momentum_logistic | 0.150 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_momentum_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_nw_logistic | 0.020 | 6 | -0.8100 | -0.8700 | -0.9300 |
| walk_forward | 2 | market_nw_logistic | 0.050 | 3 | +0.2800 | +0.2500 | +0.2200 |
| walk_forward | 2 | market_nw_logistic | 0.080 | 1 | +0.3800 | +0.3700 | +0.3600 |
| walk_forward | 2 | market_nw_logistic | 0.100 | 1 | +0.4200 | +0.4100 | +0.4000 |
| walk_forward | 2 | market_nw_logistic | 0.120 | 1 | +0.5800 | +0.5700 | +0.5600 |
| walk_forward | 2 | market_nw_logistic | 0.150 | 1 | +0.5700 | +0.5600 | +0.5500 |
| walk_forward | 2 | market_nw_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_only_logistic | 0.020 | 1 | +0.4200 | +0.4100 | +0.4000 |
| walk_forward | 2 | market_only_logistic | 0.050 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_only_logistic | 0.080 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_only_logistic | 0.100 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_only_logistic | 0.120 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_only_logistic | 0.150 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_only_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_score_logistic | 0.020 | 6 | -1.0000 | -1.0600 | -1.1200 |
| walk_forward | 2 | market_score_logistic | 0.050 | 1 | +0.5900 | +0.5800 | +0.5700 |
| walk_forward | 2 | market_score_logistic | 0.080 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_score_logistic | 0.100 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_score_logistic | 0.120 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_score_logistic | 0.150 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_score_logistic | 0.200 | 0 | +0.0000 | +0.0000 | +0.0000 |
| walk_forward | 2 | market_structure_logistic | 0.020 | 3 | -0.7100 | -0.7400 | -0.7700 |
